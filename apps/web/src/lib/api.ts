...
export type Quote = {distance_km:number;duration_minutes:number;polyline?:string|null;prices:Price[];loader_rate:number;approximate:boolean;quote_token:string};
